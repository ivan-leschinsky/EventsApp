...
namespace EventsWebApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginPageModel inputmodel, string returnUrl)
        {
            LoginModel model = inputmodel.loginModel;
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult Register(LoginPageModel inputmodel)
        {
            RegisterModel model = inputmodel.registerModel;
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    return RedirectToAction("FirstSetup", "UserProfile");
                    //return RedirectToAction("Index", "Events");
                }
            ...
            // If we got this far, something failed, redisplay form
            return View(new LoginPageModel() { registerModel = model });
        }
